...
const Terms = () => {
  ...
  return (
    <Box paddingTop="68px">
      <Container>
        <Typography textAlign="center" fontSize="28px" fontWeight="800" mb="80px">
        ...
        >
          <Typography marginBottom={4} sx={baseTextStyles}>
            Welcome to Fantasy Games! We hope you’ll enjoy being a part of our community by participating in online
            gaming challenges, competitions and tournaments and using other applications, tools and services.
          </Typography>
          <Typography marginBottom={4} sx={baseTextStyles}>
            BY REGISTERING FOR AN ACCOUNT WITH US (your “Account”), USING THE SERVICES IN ANY WAY, CLICKING “I ACCEPT”
            BELOW, DOWNLOADING ANY APPLICATION INTEGRATED WITH FANTASY GAMES, OR REGISTERING FOR OR PARTICIPATING IN ANY
            COMPETITIONS, YOU: (A) ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS AND CONDITIONS OF SERVICE AND ALL
            OBLIGATIONS AND RULES THAT MAY BE INCLUDED WITHIN EACH COMPETITION IN WHICH YOU PARTICIPATE (“Rules”) (these
            Terms and Conditions of Service, the terms of any policy incorporated herein, and the Rules are collectively
            referred to as the “Terms”) IN THEIR ENTIRETY; (B) AGREE TO BE BOUND BY THE TERMS; AND (C) ARE AUTHORIZED
            AND ABLE TO ACCEPT THESE TERMS. If you don’t wish to be bound by the Terms, do not click “I accept” and do
            not register with Fantasy Games (“Fantasy Games”, “we” or “us”) and do not use the Services. Declining to
            accept these Terms means you will be unable to participate in Competitions or use your Fantasy Games
            account.
          </Typography>

          <Typography sx={titleStyles}>1. GENERAL TERMS</Typography>
          <Typography sx={baseTextStyles}>
            1.1. ARBITRATION. TO THE MAXIMUM EXTENT PERMITTED UNDER APPLICABLE LAW, ANY CLAIM, DISPUTE OR CONTROVERSY OF
            WHATEVER NATURE (“CLAIM”) ARISING OUT OF OR RELATING TO THESE TERMS AND/OR OUR SOFTWARE OR SERVICES MUST BE
            RESOLVED BY FINAL AND BINDING ARBITRATION IN ACCORDANCE WITH THE PROCESS DESCRIBED IN SECTION 14 BELOW.
            PLEASE READ SECTION 14 CAREFULLY. TO THE MAXIMUM EXTENT PERMITTED UNDER APPLICABLE LAW, YOU ARE GIVING UP
            THE RIGHT TO LITIGATE (OR PARTICIPATE IN AS A PARTY OR CLASS MEMBER) ALL DISPUTES IN COURT BEFORE A JUDGE OR
            JURY.
          </Typography>
          <Typography sx={baseTextStyles}>
            1.2. Changes to the Terms. We may amend, change, modify or revise the Terms at any time, and we may post a
            notice on our website at (“Website”) of any material changes, and you can see when these Terms were last
            revised by referring to the “Updated” legend above. Your continued participation in Competitions and/or use
            of Software or Services means you accept any new or modified Terms. You are responsible for reviewing the
            Terms for any changes, so please check back here from time to time.
          </Typography>
          <Typography sx={baseTextStyles}>
            1.3. Eligibility. You may not modify these Terms except in writing signed by both you and Fantasy Games. For
            purposes of these Terms, “writing” does not mean an email nor an electronic/facsimile signature.
          </Typography>
          <Typography sx={baseTextStyles}>
            1.3.1. United States (U.S.). To be eligible to register an Account, to participate in any Competition or
            receive Services, and/or to download Software, you must: (a) be a natural person who is at least 18 years of
            age or older, and who is personally assigned to the email address submitted during your Account
            registration; (b) have the power to enter into a contract with Fantasy Games; (c) be physically located
            within the U.S. when accessing your Account and participating in Competitions; (d) be physically located
            within a U.S. state in which participation in the Competition you select is unrestricted by that state’s
            laws; and (e) at all times abide by these Terms. If any one of these requirements is not met at any time,
            we, as agent for our developer partners, may suspend or close your Account with or without notice.
          </Typography>

          <Typography sx={baseTextStyles}>
          1.3.2. Non-U.S. To be eligible to register an Account, to participate in any Competition or receive Services, and/or to download Software, you must: (a) be a natural person who is at least 18 years of age or older, and who is personally assigned to the email address submitted during your Account registration; (b) have the power to enter into a contract with Fantasy Games; (c) be physically located in a jurisdiction in which participation in the Competition you select is permitted and unrestricted by that state or country’s laws; and (d) at all times abide by these Terms. If any one of these requirements is not met at any time, we, on behalf of our developer partners, may suspend or close your Account with or without notice. 
          </Typography>
          <Typography sx={baseTextStyles}>

1.4. Registration. When you create an Account, you will be asked for a legitimate email address that you control and to create a password. After registration, you will be given the opportunity to create a username or accept a username given by the Services. The password and username are needed to participate in the Services. As a registered user, you can update your account settings, including your email address, by logging into your Fantasy Games Account inside any Fantasy Games-enabled game and clicking “Account Settings”. Also, if you forget either your password or username, you can visit the Website or email us for help. Please keep your username and password secret because you are responsible for all activity in your Account. Although we may offer a feature that allows you to “save” or “remember” your password, this feature makes it possible for third parties to access your Account, so please use that feature prudently because such use is at your own risk. We may, in our sole discretion, reject, change, suspend and/or terminate your username. 
          </Typography>

          <Typography sx={baseTextStyles}>

1.5. Your Account. As the holder of your Account, you are solely responsible for complying with these Terms, and only you are entitled to all benefits accruing thereto. You may not allow any other person to (i) access your Account; (ii) access Services or Software through your Account; or (iii) accept or use prizes, winnings and other representative of value (including without limitation digital trophies, virtual currency or virtual goods) (collectively “Winnings”). Neither your Account nor Winnings nor any Digital Assets (defined in Section 10.3) are transferable to any other person or account. You must immediately notify us of any unauthorized use of your password or identification or any other breach or threatened breach of our security or the security of your Account in any Fantasy Games-enabled game. 
          </Typography>
...
To participate in games, the user must have previously, at the start of any game, formalized these Terms and Conditions, having expressly accepted, likewise, the Privacy Policy and Cookie Policy. In addition, prior to the start of participation in any game, the User must successfully complete the user registration process established on the Platform (user registration being understood as the only registration that allows the User to access, as a participant, the Fantasy Games Services offered through the Platform), in accordance with the following specialities: Participation without real money: when accessing an Fantasy Games video game for the first time, the Platform will ask the User for a username and to enter and validate an e-mail address and password. After this process, a tutorial will start. From this moment, the User will be able to play video games, even without having validated the e-mail address, only by playing games with virtual money ("GGs"), until they are used up. Participation with real money: in order for the User to participate in the video games or, if applicable, to challenge another user, using in any case real money, it will be necessary to make a deposit of funds. In addition to the information mentioned in point a) above, the Platform will ask the User for their date of birth and the details of their bank card to proceed with the deposit of funds in their User Account. In any case, in order to proceed with the deposit of funds it will be necessary for the User to validate the e-mail address provided at registration. The deposit methods that the User can use to deposit funds are included on the Platform, in the section "Payment Methods", and can only be used under the conditions established in that section. Participation with real money in competitions: in order to participate in competitions organized by the Platform, the User must make the corresponding deposit of funds in their User Account, fulfilling the prerequisites established in points a) and b) above. 
          </Typography>

          <Typography sx={baseTextStyles}>

1.5.2 Your username and password 
          </Typography>

          <Typography sx={baseTextStyles}>

In the event of loss or forgetting the username and/or password, the User may, through the Platform, request a change of password. Once this option is requested, the User will receive an e-mail at the address provided to proceed with changing the password. In the event that the User has not provided an e-mail address as detailed in the previous section, he/she must contact Fantasy Game Customer Service in order to recover his/her username and/or password. The chosen username may be modified, free of charge, once. In case of second or subsequent modifications, its modification must be requested from the Platform, against payment. In the event that the chosen username is or contains offensive language, Fantasy Games will contact the user through the associated e-mail address requesting an immediate change in the username, if after 24 hours the user does not make any changes the account will be deactivated. The User will be responsible for maintaining the confidentiality of their username and password, as well as all transactions and movements of their User Account. The User shall be responsible for maintaining the confidentiality of his/her username and password, as well as for all transactions and movements on his/her User Account. The User is solely and exclusively responsible for the custody of his/her password and for its personal and non-transferable use, and shall be liable for any use, authorised or unauthorised, by third parties, exonerating Fantasy Game from any liability that may arise from use made in the User's name. 
          </Typography>

          <Typography sx={baseTextStyles}>

1.5.3. Single account 
          </Typography>

          <Typography sx={baseTextStyles}>

Only a single active user registration is allowed. The User may not have more than one active User Account on the Platform. Before registering another different User Account, the User must cancel the previous one. The User Account is personal and non-transferable, and reflects the economic transactions linked to the participation and use of the Fantasy Game Services offered by the Platform and any other additional services offered by Fantasy Games. Fantasy Games reserves the right to cancel all accounts associated with the same user. The transfer of funds between several accounts using the social function of the platform will mean the automatic closure of all associated accounts. 
          </Typography>

          <Typography sx={baseTextStyles}>

1.5.4. Access to the User Account by third parties 
          </Typography>

          <Typography sx={baseTextStyles}>

In the event that the User has suspicions that the User Account may be being hijacked, he or she must contact Fantasy Game to proceed with its blocking and, where appropriate, proceed to change the password. In the event of any suspicion that the password may have been disclosed to third parties, Fantasy Game recommends that it be changed immediately. In any case, for security reasons, it is recommended to change your password from time to time. Fantasy Games reserves the right to prevent the opening of a User Account when the holder of the User Account is not the User himself/herself, or to suspend the User Account (in the event that it has been successfully opened) and to withhold the balance that may be held in it. In the event that there are indications of suspicion that the User Account is being used by someone other than the person listed in the registration, or that it is being used in a fraudulent manner, Fantasy Games may cancel the User Account if there are sufficient indications of fraudulent or illicit use of the User Account. Fantasy Games is not responsible for the access of third parties to the User Account and under no circumstances will it assume responsibility for any loss, costs, claims, expenses and damages that the User may incur as a result of the unauthorized use of the User Account by any another person, or as a result of unauthorized access to the User Account. In this sense, all transactions where the username and password appear correctly will be considered valid, whether they have been authorized by the User. 
          </Typography>
...
1.5.5. Voluntary closure of the User Account 
          </Typography>

          <Typography sx={baseTextStyles}>
            
The User may request the temporary or permanent closure of their User Account. The voluntary closure period will be determined by the User, notifying the Fantasy Games Customer Service. In the event that the User requests the permanent closure of the User Account, it may not be reopened. 
          </Typography>
...
Access to the Platform is prohibited to anyone under 14 years of age. Therefore, by accepting these Terms and Conditions, the User declares and acknowledges that he/she is over 14 years of age and that, if the User is between 14 and 18 years of age, the User's legal guardian has reviewed these Terms and Conditions and has agreed to them and to the use of the Platform by the User. Notwithstanding what is stated above, Fantasy Games reserves the right to request documentary proof of your identity and age by whatever means we deem appropriate. In this regard, in the event that Fantasy Game requests the User to provide the aforementioned documentary evidence and does not send the required documentation within one (1) month, Fantasy Game will proceed to cancel the User's registration and User Account. Consequently, (i) (a) if the User Account balances are higher than the amounts deposited, Fantasy Game shall only refund the latter; (b) if the User Account balances are lower than the amounts deposited, Fantasy Games shall refund the amount of the balance that was credited to the User Account; and (ii) if the documents are inaccurate or have been altered or manipulated, Fantasy Game shall not be obliged to accept these documents as valid. In the event that point (ii) above applies, Fantasy Game reserves the right to suspend the User's Account, prohibit the User from participating in the Platform's video games and withhold all funds from the User's account, when there is evidence of falsification and the sending of forged, stolen or inappropriate documents. 
          </Typography>
...
1.6. Personal Location Data: As a part of this service, on behalf of our developer partners, we collect location information from your device. If you would like to opt out of having this information collected, you can disable location access to any game with the Fantasy Games SDK through the Settings menu on your mobile device. 
          </Typography>

          <Typography sx={baseTextStyles}>
            
1.7. Use of Information Collected: By upgrading an account and providing an email address, users authorize Fantasy Games to provide them with important announcements, relevant promotions, and other related communications relating to the Service, Software and Competitions. Users will always have the opportunity to opt out of these communications at any time. 
          </Typography>

          <Typography sx={baseTextStyles}>
            
1.8 Employee Policy: Fantasy Games employees may use the Services and/or Software for the purpose of testing the user experience, but may not withdraw money. Fantasy Games directors, contractors, affiliates, or partners may use the Website, Services and/or Software without such limitation, but only if they do not have any access to non-public information relating to the Services and/or Software that would lead to any advantage in their play using the Services and/or Software. 
          </Typography>
...
Fantasy Game reserves the right, with or without prior notice, to modify, suspend or terminate the User's access to the Platform for the following reasons (i) for technical reasons (such as technical difficulties experienced by Fantasy Game or the Internet); (ii) to improve the User's experience; (iii) when Fantasy Games has legal reasons to do so; (iv) in the event that it no longer makes commercial sense for Fantasy Game to provide the corresponding part of the Platform or; (v) in the event that Fantasy Games modifies the services or video games it provides. In the event that Fantasy Games has indications that the User has engaged in collusive or fraudulent behaviour in the use of the Fantasy Games Services offered through the Platform, it may provisionally suspend the User until the incident is clarified. In the event that Fantasy Game has sufficient evidence to be able to consider that the User has committed fraud, collusion, has made its own User Account available to third parties or has in any way violated the Terms and Conditions, Fantasy Game may transfer the User to present the allegations it deems appropriate and, after analysis, Fantasy Games may unilaterally terminate these Terms and Conditions. In this case, Fantasy Game reserves the right to close the User Account, and to retain all funds deposited in the User Account. 
          </Typography>
...
2.2. Software. If you wish to participate in Competitions or receive Services, you may be required to first download certain mobile applications from our third-party developer partners which have integrated Fantasy Games’s SDK (together with the content included therein, any associated documentation, and any application program interfaces, license keys, and patches, updates, upgrades, improvements, enhancements, fixes and revised versions of any of the foregoing, is collectively “Software”). If you do not download the Software, you will not be able to participate in Competitions or receive relevant Services. Whether you download the Software directly or from a third party, such as via an app store, your use of the Software is subject to these Terms.  
          </Typography>

          <Typography sx={baseTextStyles}>
            
2.3. Remote Access and Updates. We and/or our developer partners choose to offer technical support for Software from time to time in our discretion. Such technical support may require that we or our developer partners remotely access your device on which the Software is installed (“Device”). Also, if and when our developer partners update the Software or deploy patches, updates, and modifications to the Fantasy Games SDK integrated into the Software, as applicable, we may do so through remote access of your Device without your knowledge. You hereby consent to these activities. You acknowledge that if we or our developer partners cannot remotely access your Device, then the Software may no longer work, and this may prevent you from participating in Competitions or otherwise receiving Services. We and/or our developer partners’ access to your Device will be limited solely to (i) providing support (ii) updating the Software or (iii) determining your location for skill-gaming regulatory purposes only, and is governed by the terms of our Privacy Policy. 
          </Typography>
...
2.6. Blocking, cancellation or error of a game 
          </Typography>

          <Typography sx={baseTextStyles}>
            
The sessions of each game may be paused for one (1) hour, forcing an automatic pause of the session in case the User leaves the application voluntarily or involuntarily (due, among other causes, for reasons derived from any technical failure, loss of coverage, empty battery, etc.). In case of loss of Internet connection for any reason (loss of coverage, depleted battery, etc.), the result of the game cannot be sent to the server. In this case, the final result of the User's game will be the last score sent to the server before the disconnection occurred. If the User has not finished the game or has not been able to upload the score to the Services and/or the Fantasy Game server, the result will correspond to the last score received by the server (the result being equivalent to zero (0) if the User has not been able to send any score to the Services and/or the Fantasy Games server), the winner being the User whose score registered with the server, in accordance with the provisions of this clause, is higher. If the User, having passed a round (or having drawn for the first time in the same) in a bracket tournament, does not complete the next game in the stipulated time, he will lose the right to a prize or refund in that tournament. Without prejudice to what is stated in this Clause, Fantasy Games will not be responsible in any case for any disconnections or exits of the User's application caused by reasons attributable to the same, which the User acknowledges and accepts that may cause the impossibility of the result of the game is sent to the server, being, therefore, the result of the same equivalent to zero (0). If a competition is not completed by the corresponding ticket mini-equivalent to the prize awarded, the tournament may be cancelled by returning the full ticket fees to all participants in the competition. 
          </Typography>
...
Fantasy Game declares that it may include links to third-party websites and services on the Platform. The User accepts that he or she does not have control over the content and services of said third parties, that they may have their own terms and conditions and that they are not endorsed by Fantasy Game, so that Fantasy Game will in no case respond to the User for losses or damages that said third parties could cause. Any damage or expense caused to the User in relation to said third parties will be the responsibility of the User. In this regard, the User declares, acknowledges and guarantees that he/she is aware that when he/she provides data to third parties, he/she is providing it according to the privacy policy (if any) of those third parties, and that the Fantasy Game Privacy Policy does not apply in relation to that data. 
          </Typography>
...
2.8. Absence of guarantees 
          </Typography>

          <Typography sx={baseTextStyles}>

Fantasy Game does not assume any responsibility for guarantees, explicit or implicit, related to the platform, which is provided to the User "as is", and is provided without guarantee and without any responsibility regarding its quality, fitness for use, integrity or precision. Although Fantasy Game will make its best efforts to provide you with a service of the highest quality, reliability and security, Fantasy Games does not guarantee that the Fantasy Games Services (Website, Platform, Software, services, video games, etc.) will function uninterruptedly, punctual or error-free. Likewise, Fantasy Gamea does not guarantee that the Platform is free from viruses, bugs or other defects, and will use its best efforts to take all reasonable measures to ensure the continuity of the Fantasy Game service. Access to the Website and/or the Platform may be temporarily limited when maintenance, updating or similar tasks require it. 
          </Typography>
...
6.1. Obligations of conduct 
          </Typography>

          <Typography sx={baseTextStyles}>

The User agrees not to upload, communicate, transmit or otherwise make available content in the available chats or elsewhere on the Platform: (i) which is or may reasonably be considered to be illegal, harmful, harassing, defamatory, libellous, obscene or otherwise objectionable; (ii) which is or may reasonably be considered to be an infringement of other people's privacy; (iii) which is or may reasonably be considered to incite violence or racial or ethnic hatred; (iv) which you are not entitled to legally provide (such as information which is privileged, proprietary or confidential); (v) which infringes any intellectual property right or any other proprietary right of any third party; (vi) which contains software viruses or any other computer code, files or programs designed to interrupt, destroy or limit the functionality of the Platform or any computer software or hardware or telecommunications equipment, or which consists of unsolicited or unauthorised advertising, promotional materials, junk mail, spam, chain letters, pyramid schemes or other forms of solicitation. Likewise, the User declares, guarantees and agrees that: (i) he/she will not carry out a conduct that could damage the reputation of Fantasy Games; (ii) there is a risk of losing money by participating and/or using the Fantasy Games Services and you agree to be fully responsible for such losses; (iii) the use of the Fantasy Games Services is made at your sole risk and responsibility for what is left to your entire personal and individual decision; (iv) in relation to their losses, the User may not make any claim against Fantasy Games or its partners, directors, managers, executives or employees, without prejudice to the possibility of filing the corresponding complaints and claims with the Customer Service of Fantasy Games; (v) the origin of the funds that are deposited in the User Account for the use of the Fantasy Games Services is not illegal and that under no circumstances will you use the Fantasy Games Services as a deposit or money transfer system, also committing yourself to not use the Fantasy Games Services for any illegal, illicit or fraudulent activity. In accordance with the foregoing, if Fantasy Games suspects that a User is, or has been, part of a fraudulent, illegal activity or detects suspicious behaviour in relation to money laundering activities, or if the User proceeds in such a way as to breach the these Terms and Conditions, your access to the Fantasy Games Services may be immediately cancelled and/or your User Account blocked, in accordance with the provisions of these Terms and Conditions (without prejudice to the internal investigation actions that Fantasy Games may carry out, or exercise the legal actions that the parties may be entitled to). 
          </Typography>
...
Fantasy Games’ Designated Agent is:Magically Technology LLC,contact@fantasy games.me. 
          </Typography>
...
The Terms and Conditions are published so that they can be consulted at any time at the following link: www.Fantasy Games.com Fantasy Games reserves the right to modify, update and change the Terms and Conditions, as well as the Privacy Policy, the Cookies Policy and the rules that apply to each of the video games offered on the Platform, in which case it will inform the user of said modifications or changes, by publishing a new version of these Terms and Conditions on the Website and/or on the Platform. Notwithstanding the foregoing, and in accordance with the applicable regulations, the express consent of the User will be requested by means of a notification when logging into their User Account for the acceptance of the new version of the Terms and Conditions, and the User must expressly accept the new version of the Terms and Conditions. If you are not satisfied, you will not be able to continue participating in the Fantasy Games Services and you must immediately request that your account be blocked. In this case, and provided that there has been no breach of the Terms and Conditions by the User, the User will be reimbursed the balances that the User had available in his/her User Account at the time of closure or blocking of the account. 
          </Typography>

          <Typography sx={titleStyles}>

14. Claims and Customer Service 
          </Typography>

          <Typography sx={baseTextStyles}>

The resolution of incidents, complaints and claims in relation to the Fantasy Games Services will be carried out in accordance with the provisions of the Help section, included in the Platform and/or on the Website. The User may make any claim whenever he or she wishes to do so. To do this, you can write an e-mail to the address contact@Fantasygames.me. The User may file a claim within a period of three (3) months after the date of the circumstance that gave rise to the claim. The complaint shall always be dealt with by Fantasy Games in a mandatory manner, within a maximum period of one (1) month following receipt of the complaint. The User must indicate in his or her letter his or her Username and a brief description of the facts which are the subject of the complaint and his or her claims. Fantasy Games will not tolerate any threatening, damaging, abusive or violent behaviour by the User towards any of its employees. In the event that the User behaves in such a way (the determination of which will be at our sole discretion), Fantasy Games reserves the right to suspend and/or close their User Account, and/or to take the measures it deems appropriate. 
          </Typography>
...
The User may not transfer, assign, sub-license or give as security in any way the rights or obligations under these Terms and Conditions. 
          </Typography>
...
18.7 Language of the Terms: If we provide a translated version of these Terms, the User Terms of Service, the Developer Terms and Conditions of Service, the Affiliate Program Terms of Service, the Fantasy Games Privacy Policy, or any other terms or policy, it is for informational purposes only. If the translated version means something different than the English version, then the English meaning will be the one that applies. 
          </Typography>
...
THE HOLDER reserves the right to deny or withdraw access to the website and/or the services offered on it, without the need for any prior warning, on its own or by a third party, from those users who fail to comply with the contents of this legal notice. 
          </Typography>
...
Please send any questions or comments (including all inquiries unrelated to copyright infringement) to: Fantasy Games Customer Support, P.O. Box 445, San Francisco, CA 94104. Please print these Terms for your records. 
          </Typography>
...
At Fantasy Games Inc. (“Fantasy Games”, “we”, “us” or “our”), we take your privacy and the security of your information very seriously.This Privacy Policy Statement (“Privacy Policy”) covers Fantasy Games-owned and -operated websites, including Fantasy Games.com (“Site” or “Sites”), and any services offered by Fantasy Games including technology services that enable independent game developers to host tournaments and provide competitive gaming activity to end-users, and any use of the Fantasy Games SDK, including all Fantasy Games Public Forums, and the Developer Console (collectively, the “Services”). This Privacy Policy is incorporated into, and is part of, our Terms of Service available at https://www.fantasygames8.com which govern your access to the Site and your use of the Site and/or Services. Unless otherwise defined herein, capitalized terms shall have the meaning assigned to such terms in the Terms of Service. 
          </Typography>

          <Typography sx={baseTextStyles}>

If you have any questions regarding this Privacy Policy, please contact us at contact@Fantasy Games.me. 
          </Typography>

          <Typography sx={baseTextStyles}>

For the purposes of EU data protection laws (“Data Protection Law”), Fantasy Games is a data controller (i.e., the company that is responsible for, and controls the processing of your personal data). 
          </Typography>
...
Fantasy Games respects the privacy of children. The Services are not directed towards young children or minors under the age of 18. Please do not use the Services if you are under the age of 18. Fantasy Games is intent on complying with applicable laws and regulations regarding minors, including the United States’ Children’s Online Privacy Protection Act. Specifically, Fantasy Games will not knowingly collect and maintain any personally identifiable information from individuals under 18. 
          </Typography>

          <Typography sx={baseTextStyles}>

If you are a parent or guardian who has discovered that your child has submitted personally identifiable information, Fantasy Games will make reasonable efforts to delete the information from its database at your request. To request the deletion of your child’s information, please send an email contact@FantasyGames.me. 
          </Typography>
...
2.1.1 In the course you acting as a job applicant to, an employee of, director of, officer of, or contractor of Fantasy Games, you may provide certain Personal Information to Fantasy Games in your applicable role.  Said Personal Information could include email address, phone number, name, SSN, bank information and government identification numbers. For the purposes of the California Consumer Privacy Act (“CCPA”) this section provides the disclosure of categories of Personal Information we collect regarding the same. Depending on the activities and services that the User selects on the Website/Applications, the Company will process some or all of the following data: Data that you provided us when creating your online account and that may include, but is not limited to: your name, surname, username, e-mail address, birthdate; Information that you provide us when you make a payment on your account and which may include, but is not limited to: name, surname, postal address, date of birth, telephone number; Activity data on the Website/Applications, which would include, but are not limited to: Location, device data, source and destination data, Username, User ID, account password, gaming transactions, data related to online payments (debit/credit cards) and data provided to customer service services (including e-mails and phone calls); Data collected through cookies while using the Website/Applications, including those obtained in offline mode. For more information on the use and management of cookies, please refer to our Cookie Policy; Data provided by third parties who have previously obtained the User's consent to share with us data related to certain services, such as social networks or various mobile applications (when applicable). 
          </Typography>

          <Typography sx={baseTextStyles}>

2.1.2 Your email address and password to allow you to create a Fantasy Games account and use the Services. Your  email address may also be used for marketing and promotional emails as allowed by applicable law. 
          </Typography>
...
2.1.9 You may provide credit card information or your Paypal username to use certain features of the Services. Fantasy Games will use third-party credit card processing companies to process your transactions. Fantasy Games will not have access to your credit card data. 
          </Typography>
...
2.1.12 The purposes for we to process your data. 
          </Typography>

          <Typography sx={baseTextStyles}>

To carry out administration tasks for the Website/Applications, including those necessary for the configuration and operation of your account; To ensure the accuracy of the User's data for the purposes of preventing fraud, deceptive practices or money laundering, reducing commercial risks and protecting the integrity of our games. These activities will involve a certain degree of automation in the creation of profiles, based on the User's registration and activity data; To adhere to the General Conditions of the Website/the Applications; To process online payments with third party payment providers and/or financial institutions; To provide the User with customer service, including by phone. Telephone conversations may be recorded for security reasons, for legal requirements and to improve our services; Observe legal and regulatory obligations or respond to the requirements of public authorities. These obligations and requirements refer mainly to financial regulations, the prevention of money laundering and may entail a certain degree of automation in the creation of profiles, based on the User's registration and activity data; To protect our rights, as well as those of our related parties. In this regard, in certain cases we may consider it necessary, always acting in good faith, to record and disclose data, in order to (i) protect, defend or enforce our legal rights, as well as our privacy, security and assets, (ii) protect the security, privacy and trust of both Users and the general public, and (iii) manage commercial risk; To improve the security, services and features of the Website/Applications. This can lead to studies and surveys, and the optional request to the User to communicate their assessments and comments; To carry out possible mergers or asset sales. If the Company disposes of part or all of its business or its assets, or is involved in a merger or business transfer process, it may reveal and transfer the User's data to the other party or parties and; Provide the User, based on their optional consent, with direct marketing communications (i) of a generic nature or based in part on his/her gaming experience, and/or (ii) of a personalized nature, via e-mail, instant messaging and (where applicable) chats, SMS and telephone. 
          </Typography>

          <Typography sx={baseTextStyles}>

2.1.13 How long do we keep your data? 
          </Typography>

          <Typography sx={baseTextStyles}>

The data will be kept for the duration of the execution of the General Conditions of the Website/Applications, that is, until you decide to unsubscribe from our services, plus the retention periods provided for or authorised by special laws, once the services have been completed. 
          </Typography>
...
2.1.14. Your personal data secure and will they be kept confidential. 
          </Typography>

          <Typography sx={baseTextStyles}>

The Company carries out the data processing through partially or fully automated electronic means, protecting them with adequate security measures. However, activities capable of producing significant legal effects, such as profile-based decision-making, always involve human intervention, or else the final decision is in the hands of individuals. The Company applies the appropriate legal, administrative, organizational, technical, physical and personnel measures, both by design and by default, to prevent the loss, theft and unauthorized use, disclosure or modification of data. The Website/Applications may contain links to or from networks associated with third party websites or applications. If you access a link that directs you to any of these websites or applications, please note that these will apply their own general conditions and privacy policies. The Company declines all responsibility related to their content. Check these general policies and conditions before accepting the sending of data to these platforms. 
          </Typography>
...
2.2.3 With your consent and in connection with your use of the Fantasy Games SDK, we may use GPS technology (or other similar technology) to determine your current location in order to determine the state you are located within to establish which aspects of the Services you are permitted to use. You may withdraw your consent to our collection of your location information at any time, provided that you are not participating in cash competitions. If you choose to participate in a cash competition, you may not opt out of the collection of this type of geolocation data.  
          </Typography>

          <Typography sx={baseTextStyles}>

2.2.4 A cache is a component of your mobile device that transparently stores data for recordkeeping purposes. Cache data identifies your mobile device. Most browsers and applications are initially set up to accept such data. If you prefer, you can program your mobile device so that it does not store this information while utilizing the Fantasy Games SDK. Certain features may only be available through the collection of such data. We may use such data to assist in data collection and to track usage and trends to help us better serve you. We also permit third parties who have entered into confidentiality agreements to access such data to help us monitor use of the Fantasy Games SDK for fraud or for any other activity that does not comply with applicable laws.  
          </Typography>
...
3.1 Fantasy Games may transfer Personal Information to third parties for the purpose of providing the Services. We may disclose Personal Information to our appropriate affiliates, including third-party service providers, to provide you with the Services. These third-party service providers are not authorized to retain, share, store or use the Personal Information for any purposes other than to provide the services they have been hired to provide. 
          </Typography>

          <Typography sx={baseTextStyles}>

3.2 Certain Personal Information is transmitted to a third-party service provider for the purpose of processing any payments. The transmission of your payment information is automatic, and at no point do we, or any of our agents or employees, have the ability to review, access or retain such payment information. 3.3 Fantasy Games may also elect to transfer your Personal Information to third parties under special circumstances to: (i) to comply with a legal requirement, judicial proceeding, court order, or legal process served on Fantasy Games; (ii) to investigate a possible crime, such as fraud or identity theft; (iii) in connection with the sale, purchase, merger, reorganization, liquidation or dissolution of Fantasy Games; (iv) when we believe it is necessary to protect the rights, property, or safety of Fantasy Games or other persons; or (v) as otherwise required or permitted by law, including any contractual obligations of Fantasy Games. 
          </Typography>
...
Please contact support@Fantasy Games.com if you need details about the specific legal basis on which we are relying to process your personal data where more than one legal basis has been set out. 
          </Typography>
...
As part of your use of the Services, you are responsible for maintaining and updating, as applicable, your Account Information with current and complete information. You may edit and delete portions of your Account Information. To do this, select “My Account” in the main menu and choose which information to edit or delete. You can also delete your Fantasy Games account entirely. To do this, select “Help/Customer Service” in the main menu. Further select “Account Inquiry” and request for your account to be deleted. 
          </Typography>
...
By simply visiting the Website/applications, you do not provide any personal information, nor are you obliged to do so. We will only use data storage and retrieval devices ("Cookies") when you have given your prior consent to do so, as indicated in the user's browser pop-up window when you first access the Website/the Applications, and under the other terms and conditions set out in the Company's Cookie Policy, of which you should be aware. 
          </Typography>

          <Typography sx={baseTextStyles}>

11.1  A cookie is a file that is downloaded on your computer when you access certain websites. Cookies allow a website, among other things, to store and retrieve information about the browsing habits of a user or his/her computer and, depending on the information they contain and the way he/she uses his/her computer, they can be used to recognize the user. The user's browser stores cookies on the hard disk only during the current session, occupying a minimum amount of memory space and not harming the computer. Cookies do not contain any specific personal information, and most of them are deleted from the hard drive at the end of the browser session (so-called session cookies). Most browsers accept cookies as standard and, regardless of the browser, allow or prevent temporary or stored cookies in the security settings. 
          </Typography>
...
11.2  The types of cookies does this Website/Application use.Technical cookies: These allow access to restricted areas or the sharing of content through social networks. Personalization cookies: These are those that allow the user to access the service with some general characteristics predefined according to a series of criteria in the user's terminal, such as the language, the type of browser used to access the service, etc. Cookies for analysis: Those which, whether processed by us or by third parties, allow us to quantify the number of users and, thus, measure and carry out a statistical analysis of people's use of the service provided. To do this, browsing habits on our website are analysed in order to enhance the products and services that we offer. Third party cookies: The Website/Applications may use third party services that, on behalf of the Company, will collect information for statistical purposes, user usage of the Website/Applications and for the provision of other services related to the activity of the Website/Applications and other Internet services. In particular, this website uses: Own site cookies Third-party cookies By using this Website/the Applications, the User expressly accepts the processing of the information collected in the manner and for the purposes mentioned above. He/she also acknowledges the possibility of rejecting the processing of such data or information by rejecting the use of cookies by selecting the appropriate configuration for this purpose in his/her browser. Although this option to block cookies in your browser may not allow you to fully use all the functionalities of the Website/Applications. You can allow, block or delete cookies installed on your computer by configuring your browser options: 
          </Typography>

Chrome,Explorer,,Firefx,Safari. 
...
Pursuant to Section 1798.83 of the California Civil Code, residents of California have the right to request from a business, with whom the California resident has an established business relationship, certain information with respect to the types of Personal Information the business shares with third parties for direct marketing purposes by such a third party and the identities of the third parties with whom the business has shared such information during the immediately preceding calendar year. If you are a California resident and want a copy of this notice, please submit an email request to support@Fantasy Games.com. In your request, please specify that you want a “Your Fantasy Games Section 1798.83 California Privacy Rights Notice.” Please allow 30 days for a response. 
          </Typography>
...
The categories of Personal Information Fantasy Games has collected about you. 
          </Typography>
...
The categories of third parties with whom Fantasy Games has shared the information. 
          </Typography>

          <Typography sx={baseTextStyles}>

The specific pieces of Personal Information Fantasy Games has collected about you. 
          </Typography>

          <Typography sx={baseTextStyles}>

12.1.2 Right to opt out of the sale of your information. To exercise this right, please visit https://www.fantasygames.me/. 
          </Typography>
...
Right to be free from discrimination: Fantasy Games will not discriminate against you for exercising any of your rights under the CCPA. 
          </Typography>
...
Fantasy Games can be by email at contact@fantasygame.me. 
          </Typography>
...
We may need to request specific information from you to help us confirm your identity and ensure your right to access your personal data (or to exercise any of your other rights). This is a security measure to ensure that personal data is not disclosed to any person who has no right to receive it. We may also contact you to ask you for further information in relation to your request to speed up our response. 
          ...
          <Typography sx={baseTextStyles}></Typography>
...
Each time you use the Fantasy Games SDK, the current version of the Privacy Policy will apply. Accordingly, when you use the Fantasy Games SDK, you should check the date of this Privacy Policy (which appears at the top of the Privacy Policy) and review any changes since the last version. Our business changes frequently and this Privacy Policy is subject to change from time to time. Unless stated otherwise, our current Privacy Policy applies to all information that we have about you. We will not materially change our policies and practices to make them less protective of customer information collected in the past without the consent of affected customers. 
          </Typography>
...
To contact us with your questions or comments regarding this Privacy Policy or the information collection and dissemination practices of the Fantasy Games SDK, please email us at contact@fantasygames.com. 
          </Typography>
        </Box>
      </Container>
    </Box>
